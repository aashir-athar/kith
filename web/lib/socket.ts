// Realtime socket. Mints a single-use ticket, opens the browser WebSocket, validates every inbound
// frame against the shared schema, and reconnects with capped backoff. Same design as mobile.
