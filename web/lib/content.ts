// The decrypted payload of a message, identical to the mobile client: a chat message or a control
// op sealed to the peer, so the relay only ever sees ciphertext.
...
export function decodeContent(raw: string): Content {
  try {
    ...
    if (o.t === 'media' && (o.mediaKind === 'image' || o.mediaKind === 'voice' || o.mediaKind === 'document') && typeof o.blobId === 'string' && typeof o.keyHex === 'string' && typeof o.nonceHex === 'string' && typeof o.mime === 'string') {
      return { t: 'media', mediaKind: o.mediaKind, blobId: o.blobId, keyHex: o.keyHex, nonceHex: o.nonceHex, mime: o.mime, name: typeof o.name === 'string' ? o.name : undefined, size: typeof o.size === 'number' ? o.size : undefined, durationSec: typeof o.durationSec === 'number' ? o.durationSec : undefined };
    }
    ...
    if (o.t === 'text' && typeof o.body === 'string') {
      return { t: 'text', body: o.body, replyToSeq: typeof o.replyToSeq === 'number' ? o.replyToSeq : undefined, expiresInSec: typeof o.expiresInSec === 'number' ? o.expiresInSec : undefined };
    }
  } catch {
    // not JSON
  }
